...
import it.etianus.legal.config.audit.AuditEventConverter;
import it.etianus.legal.domain.PersistentAuditEvent;
...
import static it.etianus.legal.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
