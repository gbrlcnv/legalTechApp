...
import it.etianus.legal.repository.RequestTypeRepository;
import it.etianus.legal.service.RequestTypeService;
...
public class RequestTypeResourceIntTest {
    ...
    private static final RequestStatusEnum DEFAULT_REQ_STATUS = RequestStatusEnum.PROPOSED;
    private static final RequestStatusEnum UPDATED_REQ_STATUS = RequestStatusEnum.OPEN;
    ...
    public void createRequestType() throws Exception {
        ...
        assertThat(testRequestType.getReqStatus()).isEqualTo(DEFAULT_REQ_STATUS);
    ...
    public void getAllRequestTypes() throws Exception {
        ...
        restRequestTypeMockMvc.perform(get("/api/request-types?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].reqStatus").value(hasItem(DEFAULT_REQ_STATUS.toString())))
    ...
    public void getRequestType() throws Exception {
        ...
        restRequestTypeMockMvc.perform(get("/api/request-types/{id}", requestType.getId()))
            ...
            .andExpect(jsonPath("$.reqStatus").value(DEFAULT_REQ_STATUS.toString()))
    ...
    public void updateRequestType() throws Exception {
        ...
        RequestType testRequestType = requestTypeList.get(requestTypeList.size() - 1);
        assertThat(testRequestType.getReqStatus()).isEqualTo(UPDATED_REQ_STATUS);
