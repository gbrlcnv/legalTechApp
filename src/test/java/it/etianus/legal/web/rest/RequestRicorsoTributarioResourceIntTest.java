...
import it.etianus.legal.repository.RequestRicorsoTributarioRepository;
import it.etianus.legal.service.RequestRicorsoTributarioService;
...
public class RequestRicorsoTributarioResourceIntTest {
    ...
    public void createRequestRicorsoTributario() throws Exception {
        ...
        assertThat(testRequestRicorsoTributario.getReqType()).isEqualTo(DEFAULT_REQ_TYPE);
    }
    ...
    public void updateRequestRicorsoTributario() throws Exception {
        ...
        assertThat(testRequestRicorsoTributario.getReqType()).isEqualTo(UPDATED_REQ_TYPE);
    }
