...
import it.etianus.legal.domain.Request;
import it.etianus.legal.repository.RequestRepository;
import it.etianus.legal.service.RequestService;
...
public class RequestResourceIntTest {
    ...
    public void createRequest() throws Exception {
        ...
        assertThat(testRequest.getReqType()).isEqualTo(DEFAULT_REQ_TYPE);
    ...
    public void updateRequest() throws Exception {
        ...
        assertThat(testRequest.getReqType()).isEqualTo(UPDATED_REQ_TYPE);
