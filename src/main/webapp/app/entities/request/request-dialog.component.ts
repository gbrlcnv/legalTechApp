...
import { RequestRicorsoTributario, RequestRicorsoTributarioService } from '../request-ricorso-tributario';
...
export class RequestDialogComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        this.requestRicorsoTributarioService.query()
            .subscribe((res: HttpResponse<RequestRicorsoTributario[]>) => { this.requestricorsotributarios = res.body; }, (res: HttpErrorResponse) => this.onError(res.message));
    }
    ...
    trackRequestRicorsoTributarioById(index: number, item: RequestRicorsoTributario) {
        return item.id;
    }
}
